...
class Game(object):
    ...
    def start_new_round(self):
        ...
        try:
            ...
            print(f"got start new game error: {e}")
            self.end_game()
    ...
    def player_disconnected(self, player):
        ...
        if player in self.players:
            self.round.chat.update_chat(f"{player.get_name()} disconnected")
            #self.round.chat.update_chat(f"Player {self.players} disconnected")
