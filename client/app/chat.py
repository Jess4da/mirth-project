...
class Chat:
    def __init__(self, x, y):
        ...
        self.content = []
        self.typing = ""
        self.chat_font = pygame.font.Font('contents/font.ttf', 15)
        self.type_font = pygame.font.Font('contents/font.ttf', 30)
        self.CHAT_GAP = 20
    ...
    def draw(self, win):
        ...
        pygame.draw.line(win, (255,255,255), (self.x, self.y + self.HEIGHT - 40), (self.x + self.WIDTH, self.y + self.HEIGHT - 40), self.BORDER_THICKNESS)
        ...
        for i, chat in enumerate(self.content):
            txt = self.chat_font.render(" - " + chat, 1, (255,255,255))
