...
class BottomBar:
    ...
    def __init__(self, x, y, game):
        ...
        self.game = game
        __clear = sys_lang.lang(config['LANGUAGE']['lang'])['13']
        __eraser = sys_lang.lang(config['LANGUAGE']['lang'])['12']
        self.clear_button = TextButton(self.x + self.WIDTH - 150, self.y + 25, 100, 50, (128, 128, 128), f"{__clear}")
        self.eraser_button = TextButton(self.x + self.WIDTH - 300, self.y + 25, 100, 50, (128, 128, 128), f"{__eraser}")
